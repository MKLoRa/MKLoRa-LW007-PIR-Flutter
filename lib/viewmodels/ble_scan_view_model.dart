...
class BleScanViewModel extends ChangeNotifier {
  ...
  final _advServiceUuid = '0000aa05-0000-1000-8000-00805f9b34fb';
  ...
  Lw007DeviceSession? _connectedSession;

  Lw007DeviceSession? get connectedSession => _connectedSession;
  ...
  Future<Lw007DeviceSession> connectDevice({
    required BuildContext context,
    ...
    final granted = await _requestPermissions(context);
    if (!granted) {
      throw Lw007ProtocolException('Please allow Bluetooth connect permission first.');
    }
